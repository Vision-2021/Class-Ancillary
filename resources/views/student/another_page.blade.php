  ...
  <div id="main">
    <div id="header">
      <div id="logo">
        ...
        <div class="slogan" style="color:red;">Don't Stop Believing!</div>
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="current"><a href="{{url('another_page')}}">Question Bank</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <table class ="table table-bordered" style="width:600px;  height:80px;">
         <tr>
            <th>Name</th>
            <th>Size</th>
            <th>Date</th>
